...
func (MH *MessageHandler) ValidationMessage(message []byte) (error, []byte, []byte, int, string) {
...
func (MH *MessageHandler) GetAckMessages(ack AckMsg) string {
...
func (MH *MessageHandler) GetPrivateChatMessages(message ApiRequests.PrivateMessageRequest, isGrpcMessage bool) string {
	// 格式化私聊消息，构建消息字符串
	msg := fmt.Sprintf(`{
