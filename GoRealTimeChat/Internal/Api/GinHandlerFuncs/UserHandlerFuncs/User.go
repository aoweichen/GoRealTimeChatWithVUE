...
func (*UserHandler) UserInfo(ginCtx *gin.Context) {
	...
	if result := Model.MYSQLDB.Model(&IMUser.ImUsers{}).
		Where("id=?", person.ID).
...
func (*UserHandler) UserContactList(ginCtx *gin.Context) {
